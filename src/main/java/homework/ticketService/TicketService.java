...
public interface TicketService {
	 ...
	 *         information
	 */
	ArrayList<SeatHold> findAndHoldSeats(int numSeats, Optional<Integer> minLevel, Optional<Integer> maxLevel,
	 ...
	 */
	String reserveSeats(int levelId, int rowId, int seatId, String customerEmail);
}